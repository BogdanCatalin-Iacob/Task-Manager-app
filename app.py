...
def add_task():
    ...
    if request.method =="POST":
        ...
        mongo.db.task.insert_one(tasks)
...
def edit_task(task_id):
    ...
    if request.method == "POST":
        ...
        mongo.db.task.update_one({"_id": ObjectId(task_id)}, {"$set": submit})
...
def delete_category(category_id):
    '''
    Delete a category from db by admin user
    '''
